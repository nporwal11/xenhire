jQuery(document).ready(function ($) {
    ...
    function openInviteModal(job) {
        ...
        $('.linkedin').attr('href', 'https://www.linkedin.com/shareArticle?mini=true&url=' + encodeURIComponent(shareUrl));
        $('.facebook').attr('href', 'https://www.facebook.com/sharer/sharer.php?u=' + encodeURIComponent(shareUrl));
        $('.whatsapp').attr('href', 'https://api.whatsapp.com/send?text=Invitation for Interview for ' + encodeURIComponent(job.JobTitle) + ' at ' + encodeURIComponent(job.Employer) + '%0D%0A%0D%0A' + encodeURIComponent(shareUrl));
        $('.twitter').attr('href', 'https://twitter.com/intent/tweet?url=' + encodeURIComponent(shareUrl) + '&text=' + encodeURIComponent(job.JobTitle + ' at ' + job.Employer));
