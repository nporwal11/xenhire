jQuery(document).ready(function ($) {
    ...
    function openInviteModal(url) {
        ...
        $('.share-item.linkedin').attr('href', '' + encodeURIComponent(localUrl));
        $('.share-item.facebook').attr('href', '' + encodeURIComponent(localUrl));
        $('.share-item.whatsapp').attr('href', ' out this job opportunity: ' + encodeURIComponent(localUrl));
        $('.share-item.twitter').attr('href', '' + encodeURIComponent(localUrl) + '&text=Check out this job opportunity!');
