...
`;
  ...
  // @ts-ignore
  const isSafariOrIOS = typeof window !== 'undefined' && Boolean(window.GestureEvent); // true for Safari desktop + all iOS browsers 
  ...
  const addClasses = (container, popup, params) => {
    ...
    if (params.animation) {
      // this workaround with opacity is needed for 
  ...
  var defaultInputValidators = {
    ...
    url: (string, validationMessage) => {
      // taken from  with a small change from #1306 and #2013
